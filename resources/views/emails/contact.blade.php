...
<head>
    ...
    <!--<![endif]-->
    <link href="https://i.imgur.com/WVVGBzP.png" rel="icon">
    <link href="https://i.imgur.com/WVVGBzP.png" rel="apple-touch-icon">
    <title>Appointment Request Mail</title>
                            ...
                            <table border="0" align="center" width="590" cellpadding="0" cellspacing="0" class="container590">
                                ...
                                <tr>
                                    <td align="center" height="70" style="height:70px;">
                                        <a href="" style="display: block; border-style: none !important; border: 0 !important;"><img width="100" border="0" style="display: block; height: 70px; width: 70px;" src="https://i.imgur.com/WVVGBzP.png" alt="" /></a>
                                    </td>
                                </tr>
                    ...
                    <tr>
                        <td align="center" style="color: #343434; font-size: 24px; font-family: Quicksand, Calibri, sans-serif; font-weight:700;letter-spacing: 3px; line-height: 35px;"
                            ...
                            <div style="line-height: 35px">
                                ...
                                Appointments/Enquiries Request <span style="color: #dd3939;">Mail</span>
                            ...
                            <table border="0" width="590" align="center" cellpadding="0" cellspacing="0" class="container590">
                                <tr>
                                    <td align="left" style="color: #888888; font-size: 16px; font-family: 'Work Sans', Calibri, sans-serif; line-height: 24px;">
                                        ...
                                        @if ($appointment !== null)
                                        <p style="line-height: 24px;margin-bottom:15px;">
                                            You have received a new  request/enquiry from: {{ $appointment->name }}.
                                        </p>
                                        <p style="line-height: 24px; margin-bottom:20px;">
                                            The email address of the sender is: {{ $appointment->email }}.
                                        </p>
                                        <p style="line-height: 24px;margin-bottom:15px;">
                                            The subject of the appointment request is: {{ $appointment->subject }}.
                                        </p>
                                        <p style="line-height: 24px;margin-bottom:15px;">
                                            The message from the sender is:
                                    ...
                                    @endif
                                        ...
                                        <table border="0" align="center" width="180" cellpadding="0" cellspacing="0" bgcolor="5caad2" style="margin-bottom:20px; margin-top:50px !important;">
                                            ...
                                            <tr>
                                                <td align="center" style="color: #ffffff; font-size: 14px; font-family: 'Work Sans', Calibri, sans-serif; line-height: 22px; letter-spacing: 2px;">
                                                    ...
                                                    <div style="line-height: 22px;">
                                                        <?php if (Auth::check()): ?>
                                                            <a href="" style="margin-top: 50px; color: #ffffff; text-decoration: none; width: 300px;">All Appointments</a>
                                                        <?php else: ?>
                                                            <a href="" style="margin-top: 50px; color: #ffffff; text-decoration: none; width: 300px;">All Appointments</a>
                                                        <?php endif; ?>
                                                    </div>
                                    ...
                                    <td>
                                        <table border="0" width="300" align="left" cellpadding="0" cellspacing="0" style="border-collapse:collapse; mso-table-lspace:0pt; mso-table-rspace:0pt;"
                                            ...
                                            <tr>
                                                <!-- logo -->
                                                <td align="left">
                                                    <a href="" style="display: block; border-style: none !important; border: 0 !important;"><img width="80" border="0" style="display: block; height: 80px; width: 80px;" src="https://i.imgur.com/WVVGBzP.png" alt="" /></a>
                                                </td>
                                            </tr>
                                            ...
                                            <tr>
                                                <td align="left" style="color: #888888; font-size: 14px; font-family: 'Work Sans', Calibri, sans-serif; line-height: 23px;"
                                                    ...
                                                    <div style="color: #333333; font-size: 14px; font-family: 'Work Sans', Calibri, sans-serif; font-weight: 600; mso-line-height-rule: exactly; line-height: 23px;">
                                                        ...
                                                        Email us: <br/> <a href="mailto:" style="color: #888888; font-size: 14px; font-family: 'Hind Siliguri', Calibri, Sans-serif; font-weight: 400;">sobobay20@gmail.com</a>
                                ...
                                <tr>
                                    <td align="left" style="color: #aaaaaa; font-size: 14px; font-family: 'Work Sans', Calibri, sans-serif; line-height: 24px;">
                                        <div style="line-height: 24px;">
                                            ...
                                            <span style="color: #333333;">  &copy; Copyright <strong><span>MotionPlus Studio</span></strong>. All Rights Reserved</span>
