        ...
        <div class="col-xl-4">
            ...
            <div class="card">
                <div class="card-body profile-card pt-4 d-flex flex-column align-items-center">
                    ...
                    <img src="{{ asset('storage/uploads/' . Auth::user()->profile_image) }}" alt="Profile" class="rounded-circle">

                    @else
                        <img src="{{ asset('assets/img/avatar.jpg') }}" alt="Profile" class="rounded-circle">
                    @endif
                    <h2>{{ Auth::check() ? Auth::user()->name : '' }}</h2>
                    <h3>{{ Auth::check() ? Auth::user()->job : '' }}</h3>
                </div>
            </div>
          ...
          <div class="card">
            <div class="card-body pt-3">
              ...
              <ul class="nav nav-tabs nav-tabs-bordered">
                ...
                <li class="nav-item">
                  <button class="nav-link" data-bs-toggle="tab" data-bs-target="#profile-settings" disabled>Settings</button>
                </li>
                    ...
                    <div class="row mb-3">
                        ...
                        <div class="col-md-8 col-lg-9">
                            <div class="preview-container">
                                <div id="preview-div-profile" class="img-thumbnail" style="background: url({{ $user->profile_image ? asset('storage/uploads/' . $user->profile_image) : asset('assets/img/avatar.jpg') }}); background-repeat: no-repeat; background-size: cover; height: 100px; width: 100px; border: 3px #fff; border-radius: 10px; "></div>
                                <input type="file" name="profile_image" class="form-control-file mt-2" onchange="previewImage(this)">
                            </div>
                        </div>
                    </div>
